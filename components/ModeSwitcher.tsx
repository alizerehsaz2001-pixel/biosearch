...
import { Search, FileText, Filter, FlaskConical, BrainCircuit, ShieldCheck, Lightbulb, Scan, Compass, Unlock, GraduationCap, ChevronRight, Wrench, Mail, Cpu, Presentation, Crosshair, FileOutput, AudioWaveform, BookOpen, Database, Layers } from 'lucide-react';
...
export const MODES: { id: AppMode; icon: React.ElementType; color: string; bg: string }[] = [
  ...
  { id: 'BATCH_PROCESSOR', icon: Layers, color: 'text-teal-600', bg: 'bg-teal-50' },
